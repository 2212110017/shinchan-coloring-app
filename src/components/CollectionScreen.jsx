...
const CollectionScreen = ({ onStartChallenge }) => {
    ...
    const cardGridDynamicStyle = {
        ...
        gridTemplateColumns: isMobile 
            ? 'repeat(2, 1fr)' // スマホでは2列
            : 'repeat(auto-fit, minmax(150px, 1fr))', // PCでは自動調整
        gap: '20px',
    ...
    const screenContainerDynamicStyle = {
        textAlign: 'center',
        padding: isMobile ? '30px 10px' : '100px 300px', // スマホではパディングを減らす
        minHeight: '100vh',
...
// 🚨 修正: ここにあった screenContainerStyle と cardGridStyle と titleStyle は動的なスタイルに置き換わったため削除されています
